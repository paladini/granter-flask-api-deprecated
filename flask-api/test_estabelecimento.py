...
class EstabelecimentoTestCase(unittest.TestCase):
    ...
    def test_api_deactivate_unidade_exploracao(self):
        """Try to deactivate an specific UnidadeExploracao by it's id."""
        ...
        # Delete the UnidadeExploracao from the database
        result = self.client().put('/Estabelecimento/{}/unidadeExploracao/{}/desativar'.format(self.unidExp1["cdEstabelecimento"], res_json['idUnidadeExploracao']))
        self.assertEqual(result.status_code, 200)
